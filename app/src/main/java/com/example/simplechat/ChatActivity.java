...
public class ChatActivity extends AppCompatActivity {
            ...
            if(task.isSuccessful()){
                ...
                if(chatroomModel==null){
                    ...
                    chatroomModel = new ChatroomModel(
                            ...
                            Timestamp.now(),
                            "" // we don't have any message at first
                    );
                    FirebaseUtil.getChatroomReference(chatroomId).set(chatroomModel);
                }
            }
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAAypWpRvQ:APA91bFrgu_L32v128ilj221Rma9kYVJIBr70TMloiCVLHEP6fgkOcwNRHV5NdqqZzyGW3C2XujDc3uPIzAkjtYi9EhOC7eT8TVAmaNiqxzdWqlGfd2b2MovGlb6TnBXGJ6_34qDIupR")
                .build();
